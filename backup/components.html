...
<head>
	...
	<title>Bootstrap UI kit - Create e-commerce website with html uikit</title>
	...
	<!-- Bootstrap-ecommerce -->
	<link href="bootstrap-ecommerce-html/css/bootstrap.css?v=2.0" rel="stylesheet" type="text/css"/>
	<link href="bootstrap-ecommerce-html/css/ui.css?v=2.0" rel="stylesheet" type="text/css"/>
	<link href="bootstrap-ecommerce-html/css/responsive.css?v=2.0" rel="stylesheet" />

	<!-- fonticon -->
	<link href="bootstrap-ecommerce-html/fonts/fontawesome/css/all.min.css?v=2.0" type="text/css" rel="stylesheet">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		<ul class="list-check">
			...
			<li>Converting your design into HTML5/CSS code</li>
		...
		<div class="navbar-top-wrap">
			<ul class="nav nav-header">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="page-components.html">Components</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="page-templates.html">Templates</a>
                </li>
                <li class="nav-item">
...
<style type="text/css">
	output{ display: block; width: 100% }
	.section-content{border-top:7px solid #eee}
...
<div class="icontext mb-3">
	<span class="icon icon-xs rounded-circle bg-primary">
		<i class="fa fa-user white"></i>
	</span>
	<p class="text">Some short text</p>
</div> <!-- iconbox // -->
<br>
<div class="icontext mb-3">
	<span class="icon icon-sm rounded-circle bg-primary">
		<i class="fa fa-user white"></i>
	</span>
	<p class="text">Some more short text
	</p>
</div> <!-- iconbox // -->
<br>
<div class="icontext mb-3">
	...
	<p class="text">Another some short text
	</p>
</div> <!-- iconbox // -->
<br>
<div class="icontext mb-3">
...
<div class="icontext mb-3">
	<span class="icon icon-xs border border-primary">
...
<br>
<div class="icontext mb-3">
	<span class="icon icon-sm border border-primary">
		<i class="fa fa-user text-primary"></i>
	</span>
	<p class="text">Some more short text
	</p>
...
<br>
<div class="icontext mb-3">
	<span class="icon icon-md border border-primary">
		<i class="fa fa-user text-primary"></i>
	</span>
	<p class="text">Another some short text
	</p>
...
<br>
<div class="icontext mb-3">
	<span class="icon icon-lg border border-primary">
		<i class="fa fa-user text-primary"></i>
	</span>
	<p class="text">Another some short text
	</p>
...
<div class="icontext mb-3">
	<img class="icon icon-xs rounded-circle" src="bootstrap-ecommerce-html/images/avatars/avatar1.jpg">
	<p class="text">Some short text</p>
</div> <!-- iconbox // -->
<br>
<div class="icontext mb-3">
	<img class="icon icon-sm rounded-circle" src="bootstrap-ecommerce-html/images/avatars/avatar2.jpg">
	<p class="text">Some more short text
	</p>
</div> <!-- iconbox // -->
<br>
<div class="icontext mb-3">
	<img class="icon icon-md rounded-circle" src="bootstrap-ecommerce-html/images/avatars/avatar3.jpg">
	<p class="text">Another some short text
	</p>
</div> <!-- iconbox // -->
<br>
<div class="icontext mb-3">
	<img class="icon icon-lg rounded-circle" src="bootstrap-ecommerce-html/images/avatars/avatar3.jpg">
	<p class="text">Another some short text
	</p>
</div> <!-- iconbox // -->
...
<div class="box">
	...
	<div class="icontext align-items-start mr-4" style="max-width: 300px;">
		...
		<div class="text">
			<h6 class="title">Mr. Ahmed Joe</h6>
			<p class="text-muted">Some description like Lorem ipsum dolor sit amet.</p>
		</div>
	</div> <!-- iconbox // -->

	<div class="icontext align-items-start mr-4" style="max-width: 300px;">
		<img class="icon icon-md rounded-circle" src="bootstrap-ecommerce-html/images/avatars/avatar1.jpg">
		<div class="text">
			<h6 class="title">Mrs. Uzbek Xonim</h6>
			<p class="text-muted">Some description like Lorem ipsum dolor sit amet.</p>
		</div>
	</div> <!-- iconbox // -->
...
<div class="box">
	...
	<div class="icontext mr-4" style="max-width: 300px;">
		<span class="icon icon-sm rounded-circle border border-primary">
	...
	<div class="icontext mr-4" style="max-width: 300px;">
		<img class="icon icon-sm rounded-circle" src="bootstrap-ecommerce-html/images/avatars/avatar1.jpg">
		<div class="text">
			Hi, Username
		</div>
	</div> <!-- iconbox // -->
...
<div class="box">
	<div class="widget dropdown d-inline-block">
		<a href="#" class="icontext mr-4 dropdown-toggle" data-toggle="dropdown">
			<span class="icon">
				...
				<span class="notify" style="top: -10px; right: -15px;">0</span>
			</span>
			<div class="text">
		...
		<div class="dropdown-menu dropdown-menu-right">
		    <a class="dropdown-item" href="#">Some notification text</a>
	...
	<div class="widget dropdown d-inline-block">
		...
		<div class="dropdown-menu dropdown-menu-right">
		    <a class="dropdown-item" href="#">Some message text</a>
		    <a class="dropdown-item" href="#">Another message</a>
		    <a class="dropdown-item" href="#">Something else here</a>
		</div>
	</div>
	...
	<div class="widget dropdown d-inline-block">
		...
		<div class="dropdown-menu dropdown-menu-right">
		    <a class="dropdown-item" href="#">Some item here</a>
...
<div class="itemside mb-3">
	<div class="aside"><img src="bootstrap-ecommerce-html/images/items/1.jpg" class="img-xs"></div>
	<div class="info">
...
<div class="itemside mb-3">
	<div class="aside"><img src="bootstrap-ecommerce-html/images/items/2.jpg" class="img-xs"></div>
	<div class="info">
...
<div class="itemside">
	<div class="aside"><img src="bootstrap-ecommerce-html/images/items/3.jpg" class="img-xs"></div>
	<div class="info">
...
<div class="itemside mb-3">
	<div class="aside"><img src="bootstrap-ecommerce-html/images/items/4.jpg" class="img-xs"></div>
	<div class="info">
		<p>Great product name <br> and second line </p>
	</div>
</div><!-- itemside // -->
...
<div class="itemside mb-3">
	<div class="aside"><img src="bootstrap-ecommerce-html/images/items/5.jpg" class="img-xs"></div>
	<div class="info">
		<p>Another name of item <br> second line text </p>	
	</div>
</div><!-- itemside // -->
...
<div class="itemside">
	<div class="aside"><img src="bootstrap-ecommerce-html/images/items/6.jpg" class="img-xs"></div>
	<div class="info">
		<p>Some name of item goes here</p> 
	</div>
</div><!-- itemside // -->
...
<div class="itemside  mb-3">
	<div class="aside">
		<img class="icon-xs rounded-circle border" src="bootstrap-ecommerce-html/images/avatars/avatar3.jpg">
	</div>
	<div class="info">
...
<div class="itemside mb-3">
	<div class="aside">
		<img class="icon-xs rounded-circle border" src="bootstrap-ecommerce-html/images/avatars/avatar2.jpg">
	</div>
	<div class="info">
...
<div class="itemside">
	<div class="aside">
		<img class="icon-xs rounded-circle border" src="bootstrap-ecommerce-html/images/avatars/avatar1.jpg">
	</div>
	<div class="info">
...
<div class="card card-body">
	<div class="row">
		...
		<div class="col-md-3">
			<figure class="itemside mb-4">
				<div class="aside"><img src="bootstrap-ecommerce-html/images/items/4.jpg" class="img-sm"></div>
				<figcaption class="info align-self-center">
		...
		<div class="col-md-3">
			<figure class="itemside mb-4">
				<div class="aside"><img src="bootstrap-ecommerce-html/images/items/5.jpg" class="img-sm"></div>
				<figcaption class="info align-self-center">
		...
		<div class="col-md-3">
			<figure class="itemside mb-4">
				<div class="aside"><img src="bootstrap-ecommerce-html/images/items/6.jpg" class="img-sm"></div>
				<figcaption class="info align-self-center">
					<a href="#" class="title">Some name of item goes here nice</a>
					<a href="#" class="btn btn-outline-primary btn-sm"> Add to cart 
						<i class="fa fa-shopping-cart"></i> 
		...
		<div class="col-md-3">
			<figure class="itemside mb-4">
				<div class="aside"><img src="bootstrap-ecommerce-html/images/items/7.jpg" class="img-sm"></div>
				<figcaption class="info align-self-center">
					<a href="#" class="title">Some name of item goes here nice</a>
					<a href="#" class="btn btn-outline-primary btn-sm"> Add to cart 
						<i class="fa fa-shopping-cart"></i> 
...
<!-- ============================ COMPONENT LOGIN 1  ================================= -->
	<div class="card">
      ...
      <div class="card-footer text-center">Don't have an account? <a href="">Sign up</a></div>
    </div> <!-- card .// -->
...
<!-- ============================ COMPONENT LOGIN 3  ================================= -->
	<div class="card">
      ...
      <form>
          ...
          <p class="text-center my-4">or access via</p>
...
<!-- ============================ COMPONENT DELIVERY  ================================= -->
    ...
    <div class="form-group">
		...
		<label class="custom-control custom-radio custom-control-inline">
		  <input class="custom-control-input" type="radio" name="gender" value="option2">
		  <span class="custom-control-label"> Express Delivery <br> $31 </span>
		</label>
	</div> <!-- form-group end.// -->
	...
	<div class="col-md-3">
		<figure class="card card-product-grid">
			<div class="img-wrap">
				...
				<img src="bootstrap-ecommerce-html/images/items/7.jpg">
			</div>
			<figcaption class="info-wrap border-top">
...
<div class="row">
	<div class="col-md-4">
		<figure class="card card-product-grid card-lg">
			<div class="img-wrap"><img src="bootstrap-ecommerce-html/images/items/9.jpg"></div>
			<figcaption class="info-wrap">
					<a class="title">Headset for gaming</a>
	...
	<div class="col-md-4">
		<figure class="card card-product-grid card-lg">
			<a href="#" class="img-wrap"><img src="bootstrap-ecommerce-html/images/items/10.jpg"></a>
			<figcaption class="info-wrap">
					<p>
						<a href="#" class="title">Another name of item</a>
					</p>
					<span class="tag">32 GB</span> <span class="tag">Brand new</span> 
					<span class="tag">256 px</span>
					<span class="tag">Water proof</span>
			</figcaption>
			<div class="bottom-wrap d-flex align-items-center">
				<div class="mr-3"> <span class="price h5">$1280</span> </div> <!-- price.// -->	
	...
	<div class="col-md-4">
		<figure class="card card-product-grid card-lg">
			<a href="#" class="img-wrap"><img src="bootstrap-ecommerce-html/images/items/11.jpg"></a>
			<figcaption class="info-wrap">
					<a href="#" class="title">Another name of item</a>
...
<div class="card card-body">
	<div class="row">
		<div class="col-md-3">
			<figure class="card-product-grid mb-0 card-sm">
				...
				<figcaption class="info-wrap text-center">
					<a href="#" class="title">Just another  product name goes here</a>
					<div class="price mt-2">$299.00</div> <!-- price-wrap.// -->
				</figcaption>
			</figure> <!-- card // -->
		</div> <!-- col.// -->
		...
		<div class="col-md-3">
			<figure class="card-product-grid mb-0 card-sm">
				<div class="img-wrap"> <img src="bootstrap-ecommerce-html/images/items/2.jpg"> </div>
				<figcaption class="info-wrap text-center">
					<a href="#" class="title">Just another  product name goes here</a>
					<div class="price mt-2">$299.00</div> <!-- price-wrap.// -->
				</figcaption>
		...
		<div class="col-md-3">
			<figure class="card-product-grid mb-0  card-sm">
				<div class="img-wrap"> <img src="bootstrap-ecommerce-html/images/items/4.jpg"> 
					<span class="topbar">
						<a href="#" class="float-right"><i class="fa fa-heart"></i></a>
					</span>
				</div>
	...
	<div class="row">
		<div class="col-md-3">
			<figure class="itemside mb-4">
				...
				<figcaption class="info align-self-center">
					<a href="#" class="title">Some name of item goes here nice</a>
					<a href="#" class="btn btn-light text-primary btn-sm"> Add to cart </a>
				</figcaption>
			</figure>
		</div> <!-- col.// -->
		...
		<div class="col-md-3">
			<figure class="itemside mb-4">
				<div class="aside"><img src="bootstrap-ecommerce-html/images/items/3.jpg" class="border img-sm"></div>
				<figcaption class="info align-self-center">
					<a href="#" class="title">Best name of item goes here demo</a>
					<a href="#" class="btn btn-light text-primary btn-sm"> Add to cart </a>
				</figcaption>
			</figure>
		</div> <!-- col.// -->
		...
		<div class="col-md-3">
			<figure class="itemside mb-4">
				<div class="aside"><img src="bootstrap-ecommerce-html/images/items/5.jpg" class="border img-sm"></div>
				<figcaption class="info align-self-center">
		...
		<div class="col-md-3">
			<figure class="itemside mb-4">
				<div class="aside"><img src="bootstrap-ecommerce-html/images/items/6.jpg" class="border img-sm"></div>
				<figcaption class="info align-self-center">
					<a href="#" class="title">Great item name goes here nice</a>
					<a href="#" class="btn btn-light text-primary btn-sm"> Add to cart </a>
				</figcaption>
			</figure>
		</div> <!-- col.// -->
		...
		<div class="col-md-3">
			<figure class="itemside mb-4">
				<div class="aside"><img src="bootstrap-ecommerce-html/images/items/7.jpg" class="border img-sm"></div>
				<figcaption class="info align-self-center">
					<a href="#" class="title">Some name of item goes here nice</a>
					<a href="#" class="btn btn-light text-primary btn-sm"> Add to cart </a>
				</figcaption>
		...
		<div class="col-md-3">
			<figure class="itemside mb-4">
				<div class="aside"><img src="bootstrap-ecommerce-html/images/items/9.jpg" class="border img-sm"></div>
				<figcaption class="info align-self-center">
					<a href="#" class="title">Some name of item goes here nice</a>
					<a href="#" class="btn btn-light text-primary btn-sm"> Add to cart </a>
				</figcaption>
...
<article class="card card-product-list">
	...
	<div class="row">
		<aside class="col-sm-4">
			<a href="#" class="img-wrap"><img src="bootstrap-ecommerce-html/images/items/1.jpg"></a>
		</aside> <!-- col.// -->
		<div class="col-sm-8">
...
<article class="card card-product-list">
	...
	<div class="row">
		<aside class="col-sm-3">
			<a href="#" class="img-wrap"><img src="bootstrap-ecommerce-html/images/items/3.jpg"></a>
		</aside> <!-- col.// -->
	...
	<div class="row no-gutters">
		<aside class="col-md-3">
			<a href="#" class="img-wrap">
				...
				<img src="bootstrap-ecommerce-html/images/items/8.jpg">
			</a>
		</aside> <!-- col.// -->
		<div class="col-md-6">
			<div class="info-main">
...
<article class="gallery-wrap"> 
	<div class="img-big-wrap">
	   <a href="#"><img src="bootstrap-ecommerce-html/images/items/3.jpg"></a>
	</div> <!-- img-big-wrap.// -->
	<div class="thumbs-wrap">
	  <a href="#" class="item-thumb"> <img src="bootstrap-ecommerce-html/images/items/1.jpg"></a>
	  <a href="#" class="item-thumb"> <img src="bootstrap-ecommerce-html/images/items/2.jpg"></a>
	  <a href="#" class="item-thumb"> <img src="bootstrap-ecommerce-html/images/items/3.jpg"></a>
	  <a href="#" class="item-thumb"> <img src="bootstrap-ecommerce-html/images/items/4.jpg"></a>
	</div> <!-- thumbs-wrap.// -->
</article> <!-- gallery-wrap .end// -->
		</aside>
...
<article class="gallery-wrap"> 
	<div class="img-big-wrap">
	   <a href="#"><img src="bootstrap-ecommerce-html/images/items/9.jpg"></a>
	</div> <!-- img-big-wrap.// -->
	<div class="thumbs-wrap">
...
<div class="card-deck mb-3 text-center">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="#" class="btn  btn-block btn-primary">Get started</a>
          </div>
        </div>
        <div class="card">
          <div class="card-header">
...
<!-- ============================ COMPONENT PRICING 2  ================================= -->
	...
	<div class="col-lg-3 col-md-6">
		<article class="card item-pricing mb-3">
			<h6 class="card-header">
				<small class="text-uppercase">Premium Package</small>
			</h6>	
			<div class="card-body">
				<p class="price"><strong>$5000 </strong> year</p>
				...
				<a href="#" class="btn btn-primary btn-block">Upgrade</a>
			</div> <!-- card-body.// -->
	...
	<div class="col-lg-3 col-md-6">
		<article class="card item-pricing mb-3">
			<h6 class="card-header">
				<small class="text-uppercase">Standart</small> <span class="badge badge-danger"> Popular </span>
			</h6>	
			<div class="card-body">
				<p class="price"><strong>$1000 </strong> year</p>
				<ul class="list-check"  style="min-height:200px">
					<li>Verified Icon </li>
		    		<li>Customized Website</li>
		    		<li>Priority Ranking: 1</li>
	...
	<div class="col-lg-3 col-md-6">
		<article class="card item-pricing mb-3">
			<h6 class="card-header">
				<small class="text-uppercase">Basic Package </small> 
			</h6>	
			<div class="card-body">
				<p class="price"><strong>$2000 </strong> year</p>
				<ul class="list-check"  style="min-height: 200px">
					<li>Verified Icon </li>
		    		<li>Customized Website</li>
		    		<li>Priority Ranking: 1</li>
	...
	<div class="col-lg-3 col-md-6">
		<article class="card item-pricing mb-3">
			<h6 class="card-header">
				<small class="text-uppercase">FREE Member</small>
			</h6>	
			<div class="card-body">
				<p class="price"><strong>FREE</strong> for life</p>
				<ul class="list-check" style="min-height: 200px">
		    		<li>Customized Website</li>
		    		<li>Priority Ranking: 1</li>
		    		<li>Customer Service</li>
...
<div class="row">
	<aside class="col-lg-4">
		<div class="card">
			<div class="card-body">
				...
				<div><strong class="h2">$9.85</strong> <span>/month</span></div>
				<small class="text-muted">Get 20% off on first year </small>
				<hr>
				<ul class="list-check">
					<li>Lifetime free</li>
	...
	<aside class="col-lg-5">
		<h4 class="mb-3">Order form sample</h4>
		<p class="text-muted">When you enter into any new area of science, you almost always find yourself with a baffling new language.</p>
		
		<form>
			<div class="form-group">
				<label>Full name</label>
				<input type="text" name="" class="form-control" placeholder="Ex. John Doe">
			</div>
			<div class="form-row">
				...
				<div class="col-md-6 form-group">
					<label>Email</label>
					<input type="email" name="" class="form-control" placeholder="Type here">
				</div>
			</div>
			<div class="form-group">
				<label>Address</label>
				<input type="text" name="" class="form-control" placeholder="Street name, Building, Office">
			</div>
			<div class="form-group">
				<label class="custom-control custom-checkbox">
				  <input type="checkbox" class="custom-control-input" id="customCheck1">
				  <div class="custom-control-label" for="customCheck1">By clicking you agree to the Terms</div>
				</label>
			</div>
...
<ul class="list-group">
	...
	<a class="list-group-item active" href="#"> Transactions </a>
	<a class="list-group-item" href="#"> Return and refunds </a>
	<a class="list-group-item" href="#">Settings </a>
	<a class="list-group-item" href="#"> My Selling Items </a>
	<a class="list-group-item" href="#"> Received orders </a>
...
<div class="row">
		<div class="col-md-3">
			<figure class="card card-product-grid  mb-3">
				<div class="img-wrap"> <img src="bootstrap-ecommerce-html/images/items/1.jpg"> </div>
				<figcaption class="info-wrap">
					<a href="#" class="title text-truncate">Great product name should be here</a>
					<p class="price mb-2">$1280</p>
					<a href="#" class="btn btn-primary btn-sm"> Add to cart </a>
					<a href="#" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Remove from wishlist"> <i class="fa fa-times"></i> </a>
				</figcaption>
		...
		<div class="col-md-3">
			<figure class="card card-product-grid  mb-3">
				<div class="img-wrap"> <img src="bootstrap-ecommerce-html/images/items/3.jpg"> </div>
				<figcaption class="info-wrap">
					<a href="#" class="title text-truncate">Another name of item goes here</a>
					<p class="price mb-2">$1280</p>
					<a href="#" class="btn btn-primary btn-sm"> Add to cart </a>
					<a href="#" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Remove from wishlist"> <i class="fa fa-times"></i> </a>
				</figcaption>
		...
		<div class="col-md-3">
			<figure class="card card-product-grid  mb-3">
				<div class="img-wrap"> <img src="bootstrap-ecommerce-html/images/items/2.jpg"> </div>
				<figcaption class="info-wrap">
					<a href="#" class="title text-truncate">Another product name</a>
					<p class="price mb-2">$1280</p>
					<a href="#" class="btn btn-primary btn-sm"> Add to cart </a>
					<a href="#" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Remove from wishlist"> <i class="fa fa-times"></i> </a>
				</figcaption>
		...
		<div class="col-md-3">
			<figure class="card card-product-grid  mb-3">
				<div class="img-wrap"> <img src="bootstrap-ecommerce-html/images/items/4.jpg"> </div>
				<figcaption class="info-wrap">
					<a href="#" class="title text-truncate">Better item name</a>
					<p class="price mb-2">$1280</p>
					<a href="#" class="btn btn-primary btn-sm"> Add to cart </a>
					<a href="#" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Remove from wishlist"> <i class="fa fa-times"></i> </a>
				</figcaption>
...
<div class="row">
	...
	<article class="box mb-3">
		<div class="icontext w-100">
			<img src="bootstrap-ecommerce-html/images/avatars/avatar2.jpg" class="img-xs icon rounded-circle">
			<div class="text">
				<span class="date text-muted float-md-right">24.04.2020 </span>  
		...
		<div class="mt-3">
			<p>
				Not good item for dummy text item Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod 
	...
	<article class="box mb-3">
		<div class="icontext w-100">
			<img src="bootstrap-ecommerce-html/images/avatars/avatar3.jpg" class="img-xs icon rounded-circle">
			<div class="text">
				<span class="date text-muted float-md-right">24.04.2020 </span>  
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card bg-dark">
        <img src="bootstrap-ecommerce-html/images/banners/banner1.jpg" class="card-img opacity">
    ...
    <div class="col-md-4">
      <div class="card bg-dark">
        <img src="bootstrap-ecommerce-html/images/banners/banner2.jpg" class="card-img opacity">
        <div class="card-img-overlay text-white">
    ...
    <div class="col-md-4">
      <div class="card bg-dark">
        <img src="bootstrap-ecommerce-html/images/banners/banner3.jpg" class="card-img opacity">
        <div class="card-img-overlay text-white">
...
<div class="row">
    <div class="col-md-4">
<!-- ============================ COMPONENT BANNER 1 ================================= -->
<div class="card-banner" style="height:220px; background-image: url('bootstrap-ecommerce-html/images/banners/banner4.jpg');">
...
<!-- ======================= COMPONENT BANNER 1  END .// ============================ -->
    ...
    <div class="col-md-4">
<!-- ============================ COMPONENT BANNER 2 ================================= -->
<div class="card-banner" style="height:220px; background-image: url('bootstrap-ecommerce-html/images/banners/banner5.jpg');">
...
<!-- ============================ COMPONENT BANNER 2  END .// =========================== -->
    ...
    <div class="col-md-4">
<!-- ============================ COMPONENT BANNER 3 ================================= -->
<div class="card-banner" style="height:220px; background-image: url('bootstrap-ecommerce-html/images/banners/banner6.jpg');">
...
<!-- ============================ COMPONENT BANNER 4 ================================= -->
      <div class="card-banner">
        <div class="card-body" style="height:250px; background-image: url('bootstrap-ecommerce-html/images/banners/banner7.jpg');"> </div>
...
<!-- ======================= COMPONENT BANNER 4  END .// ============================ -->
    ...
    <div class="col-md-4">
<!-- ============================ COMPONENT BANNER 5  ================================= -->
      <div class="card-banner" style="height:250px; background-image: url('bootstrap-ecommerce-html/images/banners/banner8.jpg');">
...
<!-- ============================ COMPONENT BANNER 5  END .// =========================== -->
    ...
    <div class="col-md-4">
<!-- ============================ COMPONENT BANNER 6 ================================= -->
    <div class="card-banner align-items-end" style="height:250px; background-image: url('bootstrap-ecommerce-html/images/banners/banner9.jpg');">
...
<!-- ============================ COMPONENT BANNER 7  END .// =========================== -->
    ...
    <div class="col-md-4">
<!-- ============================ COMPONENT BANNER 8  ================================= -->
<div class="card-banner overlay-gradient" style="min-height:230px; background-image: url('bootstrap-ecommerce-html/images/posts/3.jpg');">
  <div class="card-img-overlay text-white">
...
<div class="row">
  <div class="col-md-4">
    ...
    <div class="shadow-sm card-banner">
      ...
      <img src="bootstrap-ecommerce-html/images/banners/banner-item1.jpg" height="150" class="img-bg">
    </div>
  ...
  <div class="col-md-4">
    ...
    <div class="shadow-sm card-banner">
      ...
      <img src="bootstrap-ecommerce-html/images/banners/banner-item2.jpg" height="150" class="img-bg">
    </div>
    <!-- ============================ COMPONENT ITEM BG  END .// =========================== -->
  </div> <!-- col.// -->
  <div class="col-md-4">
    ...
    <div class="shadow-sm card-banner">
      ...
      <img src="bootstrap-ecommerce-html/images/banners/banner-item3.jpg" height="150" class="img-bg">
    </div>
    <!-- ============================ COMPONENT ITEM BG  END .// =========================== -->
  </div> <!-- col.// -->
</div> <!-- row.// -->
...
<nav class="navbar navbar-main navbar-expand-lg navbar-light">
  <div class="container">
    <a class="navbar-brand" href="#"><img src="bootstrap-ecommerce-html/images/logo.png" class="logo"></a>
...
<div class="container">
  ...
  <a href="#" class="ml-md-3 btn btn-primary">My cart (2)</a>
  </div> <!-- navbar-collapse.// -->
</div> <!-- container.// -->
</nav>
</header> <!-- section-header.// -->
...
<div class="container">
  ...
  <a href="#" class="ml-md-3 btn btn-primary">My cart</a>
  </div> <!-- navbar-collapse.// -->
 </div> <!-- container.// -->
</nav>
</header> <!-- section-header.// -->
...
<div class="row align-items-center">
	...
	<a href="http://bootstrap-ecommerce.com" class="brand-wrap mb-0">
		<img class="logo" src="bootstrap-ecommerce-html/images/logo.png">
	</a> <!-- brand-wrap.// -->
	</div>
...
<nav class="navbar navbar-main  navbar-expand-lg navbar-light">
  <div class="container">
  	<a class="navbar-brand" href="http://bootstrap-ecommerce.com"><img src="bootstrap-ecommerce-html/images/logo.png" class="logo"></a>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-md-5 col-lg-4 col-sm-12 col-12 text-md-right">
        <div>
          ...
          <a href="#" class="btn btn-light"> My cart <span class="ml-2 badge badge-warning">4</span>
          </a>  
  ...
  <div class="container">
    <div class="collapse navbar-collapse" id="main_nav8">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="http://example.com" data-toggle="dropdown">USD</a>
...
<nav class="navbar navbar-main navbar-expand-lg navbar-light">
  <div class="container">
  	...
  	<a href="" class="btn btn-light d-md-none">My cart (2)</a>
...
<output>
  ...
  <header class="section-header">
      ...
      <nav class="navbar p-0 navbar-light border-bottom">
      	 <div class="container">
        <div class="nav language"><a href="#" class="nav-link"> Rus </a> <a href="#"
            class="nav-link current"> Eng </a> </div>
	        <ul class="nav mobile-hide">
	          ...
	          <li><a href="#" class="nav-link"> Compare  </a></li>
	        </ul> <!-- list-inline //  -->
	        </div> <!-- container.// -->
      </nav>
      ...
      <section class="header-main">
        ...
        <div class="row row-sm">
          <div class="col-6 col-sm-6 col-lg col-sm-5 col-md flex-grow-0">
            <a href="#" class="brand-wrap">
              <img class="logo" src="bootstrap-ecommerce-html/images/logo.png">
            </a> <!-- brand-wrap.// -->
          </div>
          <div class="col-6 col-sm-6 col-lg col-sm col-md flex-grow-0">
            <div class="dropdown float-right">
              <button type="button" class="btn btn-primary text-nowrap"> <i class="fa fa-bars"></i>  <span class="text">Category</span></button>
            </div> <!-- category-wrap.// -->
          </div> <!-- col.// -->
          <div class="col-12 col-sm-12 col-md col-lg-3 col-xl">
          ...
          <div class="col-12 col-lg col-md-12">
            <div class="mt-md-3 mt-lg-0 text-lg-right">
              <div class="dropdown d-inline-block">
                <a href="#" class="btn btn-light" data-toggle="dropdown"> <i class="fa fa-user"></i> <span class="text">Log in</span> </a>
                <div class="dropdown-menu">
              ...
              <a href="#" class="btn btn-light"> <i class="fa fa-shopping-cart"></i> 
      ...
      <nav class="navbar navbar-main navbar-light navbar-expand">
        ...
        <ul class="navbar-nav flex-wrap">
          ...
          <li class="nav-item"> <a class="nav-link" href="#">All items</a> </li>
        </ul>
        </div> <!-- container.// -->
      </nav> <!-- navbar-main  .// -->
			...
			<div class="row">
				...
				<aside class="col-md">
					...
					<ul class="list-unstyled">
						...
						<li><a href="#"> Product samples </a></li>
					</ul>
				</aside>
			</div> <!-- row.// -->
			</div><!-- //container -->
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 text-md-right">
						<a href=""><img src="bootstrap-ecommerce-html/images/misc/appstore.png" height="30"></a>
						<a href=""><img src="bootstrap-ecommerce-html/images/misc/playmarket.png" height="30"></a>
					</div>
				</div> <!-- row.// -->
			</div><!-- //container -->
		</section>
...
<!-- ========================= SECTION STARTER THEMES END// ========================= -->
<section class="section-content bg padding-y">
<div class="container">

<header class="section-heading text-center mb-5">
	<h2 class="section-title">Starter HTML templates</h2>
	<p style="max-width: 700px" class="text-muted mx-auto">Simple e-commerce html templates on Bootstrap 4 framework. All e-commerce templates made by our <a href="http://bootstrap-ecommerce.com/">Ecommerce UI kit</a> code. Download front-end ui kit talong with basic ecommerce html templates. Can be used for any ecommerce, online shopping web sites. </p>
</header><!-- sect-heading -->


<div class="row">
	<div class="col-md-4">
		<a target="_blank" href="bootstrap-ecommerce-html/page-index-1.html" class="card-template">
			<div class="img-wrap">
				<img src="assets/images/screenshots/starter1.jpg" alt="ecommerce homepage design sample" title="ecommerce design 2020">
			</div>
	...
	<div class="col-md-4">
		<a target="_blank" href="bootstrap-ecommerce-html/page-index-2.html" class="card-template">
			<div  class="img-wrap">
				<img src="assets/images/screenshots/starter3.jpg" alt="e-commerce home design sample" title="ecommerce template">
			</div>
			<figcaption class="text-wrap">
				Home page 2
			</figcaption>
	...
	<div class="col-md-4">
		<a target="_blank" href="bootstrap-ecommerce-html/page-index-3.html" class="card-template">
			<div  class="img-wrap">
				<img src="assets/images/screenshots/starter2.jpg" alt="ecommerce main page design template" title="ecommerce starter template">
			</div>
			<figcaption class="text-wrap">
				Home page 3
			</figcaption>
	...
	<div class="col-md-4">
		<a target="_blank" href="bootstrap-ecommerce-html/page-listing-grid.html" class="card-template">
			<div class="img-wrap">
				<img src="assets/images/screenshots/starter4.jpg">
			</div>
			<figcaption class="text-wrap">
				Listing grid
			</figcaption>
	...
	<div class="col-md-4">
		<a target="_blank" href="bootstrap-ecommerce-html/page-listing-large.html" class="card-template">
			<div  class="img-wrap">
				<img src="assets/images/screenshots/starter5.jpg" title="product listing template for ecommerce">
			</div>
			<figcaption class="text-wrap">
				Listing large
			</figcaption>
	...
	<div class="col-md-4">
		<a target="_blank" href="bootstrap-ecommerce-html/page-shopping-cart.html" class="card-template">
			<div  class="img-wrap">
				<img src="assets/images/screenshots/starter6.jpg" title="product order page for ecommerce">
			</div>
			<figcaption class="text-wrap">
				Shopping cart
			</figcaption>
	...
	<div class="col-md-4">
		<a target="_blank" href="bootstrap-ecommerce-html/page-user-register.html" class="card-template">
			<div  class="img-wrap">
				<img src="assets/images/screenshots/starter7.jpg">
			</div>
			<figcaption class="text-wrap">
				Page register
			</figcaption>
	...
	<div class="col-md-4">
		<a target="_blank" href="bootstrap-ecommerce-html/page-user-login.html" class="card-template">
			<div  class="img-wrap">
				<img src="assets/images/screenshots/starter8.jpg">
			</div>
			<figcaption class="text-wrap">
				Page login
			</figcaption>
	...
	<div class="col-md-4">
		<a target="_blank" href="bootstrap-ecommerce-html/page-blank-starter.html" class="card-template">
			<div  class="img-wrap">
				<img src="assets/images/screenshots/starter9.jpg">
			</div>
			<figcaption class="text-wrap">
				Blank page
			</figcaption>
...
<section class="padding-y-lg bg-primary relative" id="download">
    <div class="container">
        <figure class="card shadow mx-auto" style="max-width: 700px;">
            <div class="p-3 p-md-5">
                <header class="mb-4 text-center">
                     <h4 class="title">Download Bootstrap Ecommerce UI</h4>
                    <p class="text-muted">Last update: Aug. 2020</p>
                </header>
                <p class="text-white-50"></p>
                <div class="row text-muted mb-3">
                    <div class="col-md">
                        <ul class="list-check">
                            <li>HTML/CSS/SASS files </li>
                            <li>Javascript snippets </li>
                            <li>Layout samples</li>
                    ...
                    <div  class="col-lg">
                        <ul class="list-check">
                            <li>50+ components</li>
                            <li>Fonts (Roboto, InterUI) </li>
                            <li>Support by author</li>
                        </ul>
                    </div>
                </div>   <!-- row.// -->
                <div class="text-center">
                	
                	<a href="https://gumroad.com/l/bootstrap-ecommerce-uikit" target="_blank" class="btn btn-success text-uppercase btn-lg shadow-sm"> Download all  </i></a>

                </div>
                <p class="text-center my-3"> <b>Only $7</b>  &nbsp; <del class="text-danger">$20</del>  
                </p>
                <p class="text-center text-muted"><i class="fa fa-lock"></i> Secure Checkout by Gumroad </span> &nbsp; <img height="16" src="assets/images/misc/payments.png"></p>
              
                <hr>
                <p class="text-center mb-0">Any problem? <a href="#modal_hire" data-toggle="modal">Contact</a> </p>
            </div>
        </figure>
        <br><br>
        <p class="text-center">
                <span class="text-white-50">Need design version? </span> <br> <a target="_blank" href="https://ecommerce-uikit.com/" class="btn-link text-white">Get Sketch &amp; Figma file</a>
        </p>
    </div> <!-- container .//  -->
</section>
...
<script src="bootstrap-ecommerce-html/js/script.js?v=2.0" type="text/javascript"></script>
