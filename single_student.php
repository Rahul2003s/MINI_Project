...
$query="SELECT * FROM `miniproject`.`registration_no` WHERE id='$stud_id';";
                            ...
                            <div>
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: rgb(242, 222, 222); --darkreader-inline-bgcolor:#381616;" data-darkreader-inline-bgcolor=""><?php echo $row['name']; ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="background-color: rgb(242, 222, 222); --darkreader-inline-bgcolor:#381616;" data-darkreader-inline-bgcolor=""><?php echo $row['reg_no']; ?></td>
                                    </tr>
                                     <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: rgb(242, 222, 222); --darkreader-inline-bgcolor:#381616;" data-darkreader-inline-bgcolor=""><?php echo $row['email']; ?></td>
                                    </tr>
                                    <tr>
                                        <td style="background-color: rgb(171, 166, 191); font-weight: bold; --darkreader-inline-bgcolor:#403c53;" data-darkreader-inline-bgcolor="">Program</td>
